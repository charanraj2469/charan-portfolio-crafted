...
export function About() {
  return (
    <section id="about" className="py-32 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/20">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-gradient-to-b from-purple-500 to-blue-500 pl-6 relative">
                  ...
                  <h4 className="font-semibold text-gray-900 text-lg">Frontend Developer Intern</h4>
                  <p className="text-purple-600 font-medium">CodeTech IT Solutions</p>
                  <p className="text-gray-500 text-sm">Feb 2025 – Mar 2025</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/20">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-gradient-to-b from-yellow-400 to-orange-500 pl-6 relative">
                  ...
                  <h4 className="font-semibold text-gray-900 text-lg">Bachelor of Business Administration</h4>
                  <p className="text-orange-600 font-medium">Avinash College of Commerce</p>
                  <p className="text-gray-500 text-sm">2021–2024 • CGPA: 8.6</p>
                </div>
              </div>
            </div>
          </div>
